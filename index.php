...
<body>
        ...
        <div class="container">
            ...
            <nav>
                <ul>
                    ...
                    <li>
                        <a href="admin.php" class="blog-link">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
    ...
    <main class="container">
        <div class="blog-grid">
            <?php if (empty($posts)): ?>
                <div class="no-posts">
                    <p>No posts available yet. <a href="admin.php">Create your first post</a></p>
                </div>
            <?php else: ?>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-left">
                    <h3>BLOG MIGUEL</h3>
                    <p>A personal blog sharing thoughts and experiences about technology, life, and everything in between.</p>
                </div>
            ...
            <div class="footer-bottom">
                <p>&copy; <?php echo date('Y'); ?> Blog Miguel. All rights reserved.</p>
            </div>
        </div>
    </footer>
